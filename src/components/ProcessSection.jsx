...
const ProcessSection = () => {
  ...
  return (
    <section id="proceso" className="py-20 relative">
      <div className="absolute top-1/3 right-1/4 w-[300px] h-[300px] bg-purple-600/20 rounded-full blur-[100px] -z-10 opacity-30" />
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
            ...
            >
              <div className="border border-slate-800 rounded-lg p-6 bg-slate-900/50 backdrop-blur-sm h-full">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-medium text-slate-100">{step.title}</h3>
                </div>
          ...
          <div className="absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-blue-600 to-purple-600 hidden lg:block -z-0" />
        </div>
      </div>
    </section>
  )
